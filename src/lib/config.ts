...
const KEYS: {
  ...
  { name: "EVOLUTION_API_URL", label: "Evolution API URL (personal WhatsApp)", scope: "messaging", editable: true },
  { name: "EVOLUTION_API_KEY", label: "Evolution API Key", scope: "messaging", editable: true },
  ...
  { name: "STRIPE_SECRET_KEY", label: "Stripe Secret Key (optional)", scope: "billing", editable: true },
  { name: "STRIPE_WEBHOOK_SECRET", label: "Stripe Webhook Secret (optional)", scope: "billing", editable: true },

...
export const PROMPTS: PromptDef[] = [
  {
    ...
    def:
      ...
      " durationDays?: number (ONLY if the traveller stated how long - never guess a length)," +
      " startDate?: string (YYYY-MM-DD, only if the traveller stated when)," +
      ...
      " notes?: string, vendorMessage: string }. Only include durationDays/startDate/driverAge/license/" +
      "insuranceTier/oneWayDropOff/helmetCount when the traveller actually mentioned them - " +
      "never invent a date, a trip length or an age. (A REQUIRED durationDays with a floor of 1 is " +
      "how a traveller who picked 3 days got a 1-day rental quoted to twenty shops: handed prose " +
